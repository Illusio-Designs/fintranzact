...
:::tip
Select your role using the **CA / Business** toggle in the header. The FAQ below adapts to show the most relevant questions. Developers building on the API should head to the [API documentation](${import.meta.env.VITE_API_URL ?? 'https://api.hisaabo.in'}) for endpoints, auth, and integration examples.
:::
